...
var UnstableContext = React5.createContext({});
...
var Handles = React7.forwardRef(function(props, ref) {
  ...
  var _React$useState = React7.useState(false), _React$useState2 = _slicedToArray(_React$useState, 2), activeVisible = _React$useState2[0], setActiveVisible = _React$useState2[1];
  var _React$useState3 = React7.useState(-1), _React$useState4 = _slicedToArray(_React$useState3, 2), activeIndex = _React$useState4[0], setActiveIndex = _React$useState4[1];
  ...
  }), activeHandleRender && activeVisible && React7.createElement(Handle_default, _extends({
    key: "a11y"
  }, handleProps, {
...
var Marks = function Marks2(props) {
  ...
  return React9.createElement("div", {
    ...
    return React9.createElement(Mark_default, {
      key: value,
...
var Steps = function Steps2(props) {
  ...
  return React11.createElement("div", {
    ...
    return React11.createElement(Dot_default, {
      prefixCls,
      key: dotValue,
      value: dotValue,
      style,
...
var Tracks = function Tracks2(props) {
  ...
  var tracksNode = classNames3.tracks || styles.tracks ? React13.createElement(Track_default, {
    index: null,
    prefixCls,
  ...
  return React13.createElement(React13.Fragment, null, tracksNode, trackList.map(function(_ref, index) {
    var start = _ref.start, end = _ref.end;
    return React13.createElement(Track_default, {
      index,
      prefixCls,
...
function useDrag(containerRef, direction, rawValues, min, max, formatValue, triggerChange, finishChange, offsetValues, editable, minCount) {
  ...
  var _React$useState5 = React14.useState(false), _React$useState6 = _slicedToArray(_React$useState5, 2), draggingDelete = _React$useState6[0], setDraggingDelete = _React$useState6[1];
  var _React$useState7 = React14.useState(rawValues), _React$useState8 = _slicedToArray(_React$useState7, 2), cacheValues = _React$useState8[0], setCacheValues = _React$useState8[1];
  var _React$useState9 = React14.useState(rawValues), _React$useState10 = _slicedToArray(_React$useState9, 2), originValues = _React$useState10[0], setOriginValues = _React$useState10[1];
  var mouseMoveEventRef = React14.useRef(null);
  var mouseUpEventRef = React14.useRef(null);
  var _React$useContext = React14.useContext(UnstableContext), onDragStart = _React$useContext.onDragStart, onDragChange = _React$useContext.onDragChange;
...
var Slider = React16.forwardRef(function(props, ref) {
  ...
  }), track !== false && React16.createElement(Tracks_default, {
    prefixCls,
    style: trackStyle,
    values: rawValues,
    startPoint,
